...
public class Player extends Entity {
    private CountFruits countFruits;
    public static float RUN_SPEED = 9;
    public static float TURN_SPEED = 100;
    ...
    public final int totalFruits = countFruits.Count();//112
    ...
    public void setTurnSpeed(float TURN_SPEED){this.TURN_SPEED = TURN_SPEED;};
    ...
    public void resetPosition() {
        setPosition(new Vector3f(45, 1, 51));
        super.setScale(1.5f);
    }

    public void fruitsCollectedNull(){
        fruitsCollected = 0;
    }
}
